user = 'hoitim.cheung'
homeDir = '/home/hoitim.cheung/o4a_followup'
...
#followUp_nSpacing = 6.0 # for injection and followUp 1-3
injOutlier_nSpacing = 4.0 # for injection and followUp 4
cluster_nSpacing = 3.0 # for injection and followUp 4
#followUp_nSpacing = 6.0 # for injection and followUp 
followUp_nSpacing = 4.0 # for injection and followUp  # for o4a we dont do clustering so reduce this parameter for lower computational cost
