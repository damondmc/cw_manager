...
def age_strainLimit(tau, Izz, I0, r):
    ...
    h0 = 2.3e-24 * (1.0 / r) * np.sqrt((1000 / tau) * (Izz / I0))
    return h0
...
def h0_from_ellipticity(freq, e, Izz, I0, r):
    ...
    h0 = 1.1e-24 * (e / 1.0e-6) * (Izz / I0) * (freq / 1.0e3) ** 2 * (1.0 / r)
    return h0
...
def ellipticity_from_h0(freq, h0, Izz, I0, r):
    ...
    e = 9.46e-5 * (h0 / 1e-24) * (I0 / Izz) * (r / 1.0) * (1e2 / freq) ** 2
    return e
...
def h0_from_alpha(freq, alpha, Izz, I0, r):
    ...
    h0 = 3.6e-23 * (alpha / 1.0e-3) * (freq / 1.0e3) ** 3 * (1.0 / r)
    return h0
...
def alpha_from_h0(freq, h0, Izz, I0, r):
    ...
    alpha = 0.028 * (h0 / 1e-24) * (r / 1.0) * (1e2 / freq) ** 3
    return alpha
